...
<title>Trip for Saturn</title>
</head>

<!---------------------------------------------- Description about trip --------------------------->
<body>
<fieldset style="float:left;height:100%;width:100%;">
<legend> Saturn Package Details</legend>
<p>
<table>
  <tr><th>Camp Duration:</th><td>189 Earth Cycles 32 yesrs</td></tr>
  <tr><th>Camp Type:</th><td>Spacewalking and Sightseeing activities</td></tr>
  <tr><th>Region:</th><td> Saturn Rings Orbit </td></tr>
  <tr><th>Accommodation:</th><td> ISRO Capsule  </td></tr>
  <tr><th>Food:</th><td> Pure Veg</td></tr>
  <tr><th>Transportation:</th><td> Suttle Rocket Proplent</td></tr>
...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
  ...
  $result = mysqli_query($con,"SELECT * FROM `saturn` ");
...
if(file_exists("Uploads/5".$row['Number'] .".pdf")){
  echo "<td> <a href ='Uploads/5".$row['Number'] .".pdf' >". $row['Full Name'] ."</a></td>";
}
...
<p><br>
Please name your Aadhar pdf As '5' + "Your No." Thank You.
<br>
<h3>Register:</h3>
<form name="Register" method="post" action="Trip_Saturn.php">
<table>
<tr>
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if (isset($_POST['Submit'])) {
    $sql = "INSERT INTO `saturn` (`Number`, `Full Name`, `Age`, `Gender`, `Phone`, `Email`) VALUES ('$Number', '$Name', '$Age', '$Gender', '$Phone', '$Email')";
  ...
  header("Location: Trip_Saturn.php");
}
?>