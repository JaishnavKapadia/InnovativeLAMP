...
<title>Trip for Mars</title>
</head>

<!---------------------------------------------- Description about trip --------------------------->
<body>
<fieldset style="float:left;height:100%;width:100%;">
<legend> Mars Package Details</legend>
<p>
<table>
  <tr><th>Camp Duration:</th><td>010 Earth Cycles 3 yesrs</td></tr>
  <tr><th>Camp Type:</th><td>Spacewalking and Sightseeing activities</td></tr>
  <tr><th>Region:</th><td> Mars Outer Orbit </td></tr>
...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
  ...
  $result = mysqli_query($con,"SELECT * FROM `mars` ");
...
if(file_exists("Uploads/4".$row['Number'] .".pdf")){
  echo "<td> <a href ='Uploads/4".$row['Number'] .".pdf' >". $row['Full Name'] ."</a></td>";
}
...
<p><br>
Please name your Aadhar pdf As '4' + "Your No." Thank You.
<br>
<h3>Register:</h3>
<form name="Register" method="post" action="Trip_Mars.php">
<table>
<tr>
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if (isset($_POST['Submit'])) {
    $sql = "INSERT INTO `mars` (`Number`, `Full Name`, `Age`, `Gender`, `Phone`, `Email`) VALUES ('$Number', '$Name', '$Age', '$Gender', '$Phone', '$Email')";
