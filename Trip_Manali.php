...
<title>Trip for Manali</title>
</head>

<!---------------------------------------------- Description about trip --------------------------->
<body>
<fieldset style="float:left;height:100%;width:100%;">
<legend> Manali Package Details</legend>
<p>
<table>
  <tr><th>Camp Duration:</th><td>010 Days 09 Nights</td></tr>
  <tr><th>Camp Type:</th><td>Snowboarding and Adventure Activities</td></tr>
  <tr><th>Region:</th><td> North, India </td></tr>
...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
  ...
  $result = mysqli_query($con,"SELECT * FROM `manali` ");
...
if(file_exists("Uploads/3".$row['Number'] .".pdf")){
  echo "<td> <a href ='Uploads/3".$row['Number'] .".pdf' >". $row['Full Name'] ."</a></td>";
}
...
<p><br>
Please name your Aadhar pdf As '3' + "Your No." Thank You.
<br>
<h3>Register:</h3>
<form name="Register" method="post" action="Trip_Manali.php">
<table>
<tr>
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  if (isset($_POST['Submit'])) {
    $sql = "INSERT INTO `manali` (`Number`, `Full Name`, `Age`, `Gender`, `Phone`, `Email`) VALUES ('$Number', '$Name', '$Age', '$Gender', '$Phone', '$Email')";
  ...
  header("Location: Trip_Manali.php");
}
?>